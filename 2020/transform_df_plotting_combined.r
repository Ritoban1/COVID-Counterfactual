...
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df$group[df$group=="Sri_Lanka" & df$colour=="Original"] = "Fit Sri"
...
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf1$group[df_cf1$group=="Sri_Lanka" & df_cf1$colour=="Original"] = "Fit Sri"
...
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf2$group[df_cf2$group=="Sri_Lanka" & df_cf2$colour=="Original"] = "Fit Sri"
...
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf3$group[df_cf3$group=="Sri_Lanka" & df_cf3$colour=="Original"] = "Fit Sri"
...
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf4$group[df_cf4$group=="Sri_Lanka" & df_cf4$colour=="Original"] = "Fit Sri"
...
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf5$group[df_cf5$group=="Sri_Lanka" & df_cf5$colour=="Original"] = "Fit Sri"
...
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf6$group[df_cf6$group=="Sri_Lanka" & df_cf6$colour=="Original"] = "Fit Sri"
...
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf7$group[df_cf7$group=="Sri_Lanka" & df_cf7$colour=="Original"] = "Fit Sri"
...
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 1"] = "Abs: Ind -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 2"] = "Abs: Nep -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 3"] = "Abs: Bang -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 4"] = "Abs: Pak -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 5"] = "Rel: Ind -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 6"] = "Rel: Nep -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 7"] = "Rel: Bang -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Scenario 8"] = "Rel: Pak -> Sri"
df_cf8$group[df_cf8$group=="Sri_Lanka" & df_cf8$colour=="Original"] = "Fit Sri"
