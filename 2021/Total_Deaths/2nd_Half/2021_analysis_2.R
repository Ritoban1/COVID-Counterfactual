...
data<-readRDS("dat_21_2.rds")
dat<- readRDS("dat_21_2.rds")
##
o2d<-function(){
...
ggsave("scenario-rt_Ind.pdf",p1,width=9,height=6)
...
p2 <- base +
  ...
  ggplot2::geom_line(
    ...
    size = 1,color='black') + xlim(as.Date('2021-01-01'), as.Date('2021-12-31'))
...
ggsave("scenario-rt_Bang.pdf",p2,width=9,height=6)
...
ggsave("scenario-rt_Pak.pdf",p3,width=9,height=6)
...
ggsave("scenario-rt_nep.pdf",p4,width=9,height=6)
...
ggsave("scenario-rt_sri.pdf",p5,width=9,height=6)
