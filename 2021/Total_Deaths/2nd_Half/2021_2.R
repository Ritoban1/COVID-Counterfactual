...
args$sampling_args <- list(iter=100, seed=12345, control=list(adapt_delta=0.95,max_treedepth=15))
...
args$rt <- epirt(
  ...
  prior = rstanarm::normal(log(1.5), 0.1)
)
...
saveRDS(fit,"fit_2021_2_urfd.rds")
