...
date_initial = as.Date("2021-04-01")
...
df_r0=df[df$date>=changeDate,c("group","date","median","median_li","median_ui")]
saveRDS(df_r0,"df_r02.rds")
df_cf1 <- data.frame(
  date = rt_cf1$time,
...
# df7_b=cumsum(df_cf7[(df_cf8$group=="Nepal" & df_cf7$date>=changeDate),]$deaths_median)/29.14
...
# df7_b=cumsum(df_cf7[(df_cf8$group=="Nepal" & df_cf7$date>=changeDate),]$deaths_li)/29.14
...
# df7_b=cumsum(df_cf7[(df_cf8$group=="Nepal" & df_cf7$date>=changeDate),]$deaths_ui)/29.14
...
p1 <-ggplot(dfrt,aes(x = Date, y = Value,color=Ind)) + geom_line(size=1) +
  ...
  xlim(as.Date('2021-07-01'), as.Date('2021-12-31')) +
  scale_x_date(
    date_breaks = date_breaks,
...
p1 <- p1 + ggplot2::labs(y = "Median Rt") + ggplot2::facet_wrap(~Group,scales="free_y") + 
  ggtitle("Effective R trajectory July 1- Dec 31 2021") + theme(legend.title=element_text(size=12))+
  theme(legend.text=element_text(size=12)) + xlab("")



ggsave("rt2021two.pdf",p1,width=11,height=8)
...
p1 <- base +
  ...
  )  + xlim(as.Date('2021-07-01'), as.Date('2021-12-31')) +  scale_x_date(
    date_breaks = date_breaks,
    labels = scales::date_format("%b")
  )
p1 <- p1 + ggplot2::labs(y = "Deaths") + ggplot2::facet_wrap(~group,scales="free_y") + 
  scale_color_brewer(palette="Paired") + ggtitle("Deaths July 1- Dec 31 2021")+xlab("")
ggsave("death2021two.pdf",p1,width=11,height=8)
...
# 
# ggsave("scenario-rt_Ind_2.pdf",p1,width=9,height=6)
# 
# p2 <- base +
#   ggplot2::geom_line(
#     mapping = ggplot2::aes(x = date, y = median, color = colour),
...
#     size = 1,color='black') + xlim(as.Date('2021-07-01'), as.Date('2021-12-31'))
...
# ggsave("scenario-rt_Bang_2.pdf",p2,width=9,height=6)
# 
# 
# p3 <- base +
#   ggplot2::geom_line(
...
# ggsave("scenario-rt_Pak_2.pdf",p3,width=9,height=6)
# 
# 
# p4 <- base +
#   ggplot2::geom_line(
...
# ggsave("scenario-rt_nep_2.pdf",p4,width=9,height=6)
# 
# 
# 
# p5 <- base +
...
# ggsave("scenario-rt_sri_2.pdf",p5,width=9,height=6)
# 
# 
# 
# 
...
# 
# df_urf=df[,c("date","infections_median","infections_ui","infections_li","country","colour")]
# df_urf=df_urf[df_urf$date>=changeDate,]
# saveRDS(df_urf,"df_urf_2.rds")
# 
# ######################################################################################################################################################
# # URF_1
# ######################################################################################################################################################
...
# ggsave("scenario-death_Ind_2.pdf",p1,width=9,height=6)
# 
# p2 <- base +
#   ggplot2::geom_line(
#     mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
# ggsave("scenario-death_Bang_2.pdf",p2,width=9,height=6)
# 
# p3 <- base +
#   ggplot2::geom_line(
#     mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
# ggsave("scenario-death_Pak_2.pdf",p3,width=9,height=6)
# 
# 
# p4 <- base +
#   ggplot2::geom_line(
...
# ggsave("scenario-death_Nep_2.pdf",p4,width=9,height=6)
# 
# p5 <- base +
#   ggplot2::geom_line(
#     mapping = ggplot2::aes(x = date, y = deaths_median, color = colour),
...
# ggsave("scenario-death_Sri_2.pdf",p5,width=9,height=6)
# 
# 
# margin = theme(plot.margin = unit(c(0.5,0.5,0.5,0.5), "cm"))
# p1=p1+margin
